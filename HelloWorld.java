...
public class HelloWorld{
    ...
    public static void addMember(ArrayList<hundredt> list, Scanner sc){
        ...
        salary =sc.nextInt();
         ...
         //adds the new member with their respective variables in the arraylist
    ...
    public static void removeMember(ArrayList<hundredt> list, Scanner sc){
        int removeIndex;
        //display list of employees so user can see which user to remove
        Summary(list);
    ...
    public static void Summary(ArrayList<hundredt> list){
        //display entire employee list from old to new
